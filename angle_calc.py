...
def rula_risk_score(point_score, wrist, trunk, upper_Shoulder, lower_Limb, neck, wrist_twist, legs, muscle_use, force_load_a, force_load_b, upper_body_muscle):
...
def reba_risk_score(point_score, wrist, trunk, upper_Shoulder, lower_Limb, neck, legs, force_load_a, coupling_score, activity_score):
...
def reba_score(angle_dict, pose, profile):
    ...
    if profile:
        ...
        activity_score=0
        try:
            reba, point_score=reba_risk_score(point_score, wrist, trunk, upper_Shoulder, lower_Limb, neck, legs, force_load_a, coupling_score, activity_score)
...
def rula_score(angle_dict, pose,profile):
    ...
    if profile:
        ...
        try:
            rula, point_score=rula_risk_score(point_score, wrist, trunk, upper_Shoulder, lower_Limb, neck, wrist_twist, legs, muscle_use, force_load_a, force_load_b, upper_body_muscle)
